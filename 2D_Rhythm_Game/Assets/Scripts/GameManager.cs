...
public class GameManager : MonoBehaviour
{
    ...
    private Sprite[] judgeSprites; //스프라이트 이미지를 담는 변수
    private Image judgementSpriteRenderer; //이미지 변수로 각각 good , bad 등의 이미지를 봐꿔주는 역할
    ...
    void MusicStart()
    {
        ...
        AudioClip audioClip = Resources.Load<AudioClip>("Beats/" + PlayerInformation.seletedMusic);
    ...
    void Start()
    {
        ...
        trailSpriteRenderers = new SpriteRenderer[trails.Length]; //초기화
